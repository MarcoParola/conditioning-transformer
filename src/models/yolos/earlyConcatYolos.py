...
class EarlyConcatenationYOLOS(nn.Module):
    def __init__(self, args):
        ...
        self.backbone.finetune_det(
            det_token_num=args.yolos.detTokenNum + 1, 
        ...
        self.metaProjection = nn.Linear(args.numMetadata * args.sequenceLength, self.backbone.embed_dim) 
